...
const Home = () => {
  return (
    ...
    <div className='border rounded-5 mt-5 fs-5 text-center mx-auto shadow' style={{width: "70%"}}>
      ...
      <p className='mb-4'><strong>Prazo das inscrições</strong> <br />De 14 de Agosto até 21 de Setembro de 2026</p>

...
const PesquisaGrad = () => {
  ...
  return (
    <div className='container'>
      <p className='display-6 mt-4'><strong>Pesquisa - Graduação</strong></p>
      ...
      <p>Prazo de submissão: <strong>14/08/2026 às 00:00</strong> até <strong>21/09/2026 às 23:59.</strong></p>
    <hr />
    <Regras />
    <hr />
